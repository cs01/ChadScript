...
function declareExterns(ctx: EmitContext): void {
  ...
  const bridgeFns: [string, any, any[]][] = [
    ...
    ["cs2_num_ptr_map_new", m.ptr, []],
    ["cs2_num_ptr_map_set", m.voidTy, [m.ptr, m.f64, m.ptr]],
    ["cs2_num_ptr_map_get", m.ptr, [m.ptr, m.f64]],
    ["cs2_num_ptr_map_has", m.i32, [m.ptr, m.f64]],
    ["cs2_num_ptr_map_delete", m.i32, [m.ptr, m.f64]],
    ["cs2_num_ptr_map_size", m.i32, [m.ptr]],
    ["cs2_num_ptr_map_clear", m.voidTy, [m.ptr]],
    ["cs2_num_ptr_map_key_at", m.f64, [m.ptr, m.i32]],
    ["cs2_num_ptr_map_value_at", m.ptr, [m.ptr, m.i32]],
    ["cs2_num_ptr_map_copy", m.ptr, [m.ptr]],
    ["cs2_num_ptr_map_keys", m.ptr, [m.ptr]],
    ...
    ["cs2_dynarray_get_boxed", m.i64, [m.ptr, m.i32]],
    ["cs2_dynarray_push_boxed", m.voidTy, [m.ptr, m.i64]],
    ...
    ["cs2_dynarray_find", m.i64, [m.ptr, m.ptr, m.ptr]],
