...
function declareExterns(ctx: EmitContext): void {
  ...
  const bridgeFns: [string, any, any[]][] = [
    ...
    ["cs2_str_join", m.ptr, [m.ptr, m.ptr]],
    ["cs2_str_count", m.i32, [m.ptr, m.ptr]],
    ["cs2_str_isdigit", m.i32, [m.ptr]],
    ["cs2_str_isalpha", m.i32, [m.ptr]],
    ["cs2_str_isspace", m.i32, [m.ptr]],
    ["cs2_str_split_whitespace", m.ptr, [m.ptr]],
    ...
    ["cs2_num_array_insert", m.voidTy, [m.ptr, m.i32, m.f64]],
    ...
    ["cs2_num_array_index_of", m.i64, [m.ptr, m.f64]],
    ...
    ["cs2_str_array_insert", m.voidTy, [m.ptr, m.i32, m.ptr]],
    ...
    ["cs2_str_array_index_of", m.i64, [m.ptr, m.ptr]],
    ...
    ["cs2_str_num_map_pop", m.f64, [m.ptr, m.ptr]],
    ["cs2_str_num_map_update", m.voidTy, [m.ptr, m.ptr]],
    ...
    ["cs2_str_str_map_pop", m.ptr, [m.ptr, m.ptr]],
    ["cs2_str_str_map_update", m.voidTy, [m.ptr, m.ptr]],
    ...
    ["cs2_dynobj_set", m.voidTy, [m.ptr, m.ptr, m.i64]],
    ["cs2_dynobj_get", m.i64, [m.ptr, m.ptr]],
    ["cs2_dynobj_has", m.i32, [m.ptr, m.ptr]],
    ["cs2_dynobj_delete", m.voidTy, [m.ptr, m.ptr]],
    ["cs2_dynobj_length", m.i32, [m.ptr]],
    ["cs2_dynobj_repr", m.ptr, [m.ptr]],
