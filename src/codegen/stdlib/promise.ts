export class PromiseGenerator {
  generateDeclarations(): string {
    ...
    ir +=
      "; { next: %PromiseCallback*, onFulfilled: void (i8*, i8*)*, onRejected: void (i8*, i8*)*, childPromise: %Promise*, context: i8* }\n";
    ir +=
      "%PromiseCallback = type { %PromiseCallback*, void (i8*, i8*)*, void (i8*, i8*)*, %Promise*, i8* }\n\n";

    ir += "; Promise struct: { state: i32, value: i8*, callbacks: %PromiseCallback* }\n";
    ir += "%Promise = type { i32, i8*, %PromiseCallback* }\n\n";

    ir +=
      "; PromiseAllState: { counter: i32*, results: %Array*, result_promise: %Promise*, total: i32, rejected: i32* }\n";
  ...
  generatePromiseRunCallbacks(): string {
    ...
    ir +=
      "  %context_ptr = getelementptr inbounds %PromiseCallback, %PromiseCallback* %callback, i32 0, i32 4\n";
    ...
    ir += "run_fulfilled:\n";
    ir +=
      "  %on_fulfilled_ptr = getelementptr inbounds %PromiseCallback, %PromiseCallback* %callback, i32 0, i32 1\n";
    ...
    ir += "run_rejected:\n";
    ir +=
      "  %on_rejected_ptr = getelementptr inbounds %PromiseCallback, %PromiseCallback* %callback, i32 0, i32 2\n";
    ...
    ir += "continue:\n";
    ir +=
      "  %next_ptr = getelementptr inbounds %PromiseCallback, %PromiseCallback* %callback, i32 0, i32 0\n";
  ...
  generatePromiseThen(): string {
    let ir =
      "; __Promise_then(%Promise* promise, void (i8*, i8*)* onFulfilled, void (i8*, i8*)* onRejected) -> %Promise*\n";
    ir += "; Adds callbacks and returns a new promise for chaining\n";
    ir +=
      "define %Promise* @__Promise_then(%Promise* %promise, void (i8*, i8*)* %onFulfilled, void (i8*, i8*)* %onRejected) {\n";
    ir += "entry:\n";
    ...
    ir +=
      "  %cb_next_ptr = getelementptr inbounds %PromiseCallback, %PromiseCallback* %cb, i32 0, i32 0\n";
    ir += "  store %PromiseCallback* null, %PromiseCallback** %cb_next_ptr\n";
    ir +=
      "  %cb_fulfilled_ptr = getelementptr inbounds %PromiseCallback, %PromiseCallback* %cb, i32 0, i32 1\n";
    ir += "  store void (i8*, i8*)* %onFulfilled, void (i8*, i8*)** %cb_fulfilled_ptr\n";
    ir +=
      "  %cb_rejected_ptr = getelementptr inbounds %PromiseCallback, %PromiseCallback* %cb, i32 0, i32 2\n";
    ir += "  store void (i8*, i8*)* %onRejected, void (i8*, i8*)** %cb_rejected_ptr\n";
    ir +=
      "  %cb_child_ptr = getelementptr inbounds %PromiseCallback, %PromiseCallback* %cb, i32 0, i32 3\n";
    ir += "  store %Promise* %child, %Promise** %cb_child_ptr\n";
    ir += "  ; Initialize context to null (for standard .then calls)\n";
    ir +=
      "  %cb_context_ptr = getelementptr inbounds %PromiseCallback, %PromiseCallback* %cb, i32 0, i32 4\n";
  ...
  generatePromiseThenWithContext(): string {
    let ir =
      "; __Promise_then_with_context(%Promise* promise, void (i8*, i8*)* onFulfilled, void (i8*, i8*)* onRejected, i8* context) -> %Promise*\n";
    ir += "; Adds callbacks with context and returns a new promise for chaining\n";
    ir +=
      "define %Promise* @__Promise_then_with_context(%Promise* %promise, void (i8*, i8*)* %onFulfilled, void (i8*, i8*)* %onRejected, i8* %context) {\n";
    ir += "entry:\n";
    ir += "  ; Create child promise\n";
    ir += "  %child = call %Promise* @__Promise_new()\n";
    ir += "\n";
  ...
  generatePromiseAllCallbacks(): string {
    ...
    ir +=
      "  %rejected_ptr_ptr = getelementptr inbounds %PromiseAllState, %PromiseAllState* %state, i32 0, i32 4\n";
  ...
  generatePromiseAll(): string {
    ...
    ir +=
      "  call %Promise* @__Promise_then_with_context(%Promise* %promise, void (i8*, i8*)* @__Promise_all_onFulfilled, void (i8*, i8*)* @__Promise_all_onRejected, i8* %ctx_i8)\n";
    ir += "\n";
  ...
  generatePromiseRaceCallbacks(): string {
    ...
    ir +=
      "  %state_ptr = getelementptr inbounds %Promise, %Promise* %result_promise, i32 0, i32 0\n";
    ir += "  %state = load i32, i32* %state_ptr\n";
  ...
  generatePromiseRace(): string {
    ...
    ir += "  %promise = load %Promise*, %Promise** %promise_slot\n";
    ir +=
      "  call %Promise* @__Promise_then_with_context(%Promise* %promise, void (i8*, i8*)* @__Promise_race_onFulfilled, void (i8*, i8*)* @__Promise_race_onRejected, i8* %ctx)\n";
    ir += "  %next_i = add i32 %i, 1\n";
    ir += "  br label %loop\n";
    ir += "\n";
    ir += "done:\n";
