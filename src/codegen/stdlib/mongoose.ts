...
export class MongooseGenerator {
  ...
  generateDeclarations(): string {
    ...
    ir +=
      "declare %struct.mg_connection* @mg_http_listen(%struct.mg_mgr*, i8*, void (%struct.mg_connection*, i32, i8*, i8*)*, i8*)\n";
  ...
  generateEventHandler(httpHandlerName: string, wsHandlerName?: string): string {
    ...
    ir +=
      `define void @__mg_http_handler(%struct.mg_connection* %conn, i32 %ev, i8* %ev_data, i8* %fn_data) {` +
      "\n";
    ir += "entry:\n";
    ...
    if (wsHandlerName) {
      ...
      ir +=
        "  %upgrade_hdr_name = getelementptr [8 x i8], [8 x i8]* @.str.upgrade_header, i32 0, i32 0\n";
      ir +=
        "  %upgrade_ptr = call %struct.mg_str* @mg_http_get_header(%struct.mg_http_message* %hm_upgrade_check, i8* %upgrade_hdr_name)\n";
      ...
      ir +=
        "  call void @mg_ws_upgrade(%struct.mg_connection* %conn, %struct.mg_http_message* %hm_upgrade_check, i8* %null_fmt)\n";
      ir += "  br label %done\n\n";
    ...
    ir +=
      "  %method_buf_ptr = getelementptr %struct.mg_http_message, %struct.mg_http_message* %hm, i32 0, i32 0, i32 0\n";
    ir += "  %method_buf = load i8*, i8** %method_buf_ptr\n";
    ir +=
      "  %method_len_ptr = getelementptr %struct.mg_http_message, %struct.mg_http_message* %hm, i32 0, i32 0, i32 1\n";
    ir += "  %method_len = load i64, i64* %method_len_ptr\n";
    ir += "\n";

    ir += "  ; Get uri mg_str (second field: offset 1)\n";
    ir +=
      "  %uri_buf_ptr = getelementptr %struct.mg_http_message, %struct.mg_http_message* %hm, i32 0, i32 1, i32 0\n";
    ir += "  %uri_buf = load i8*, i8** %uri_buf_ptr\n";
    ir +=
      "  %uri_len_ptr = getelementptr %struct.mg_http_message, %struct.mg_http_message* %hm, i32 0, i32 1, i32 1\n";
    ir += "  %uri_len = load i64, i64* %uri_len_ptr\n";
    ir += "\n";

    ir += "  ; Get query mg_str (third field: offset 2)\n";
    ir +=
      "  %query_buf_ptr = getelementptr %struct.mg_http_message, %struct.mg_http_message* %hm, i32 0, i32 2, i32 0\n";
    ir += "  %query_buf = load i8*, i8** %query_buf_ptr\n";
    ir +=
      "  %query_len_ptr = getelementptr %struct.mg_http_message, %struct.mg_http_message* %hm, i32 0, i32 2, i32 1\n";
    ir += "  %query_len = load i64, i64* %query_len_ptr\n";
    ir += "\n";

    ir += "  ; Get body mg_str (field 5: after proto and headers)\n";
    ir +=
      "  %body_buf_ptr = getelementptr %struct.mg_http_message, %struct.mg_http_message* %hm, i32 0, i32 5, i32 0\n";
    ir += "  %body_buf = load i8*, i8** %body_buf_ptr\n";
    ir +=
      "  %body_len_ptr = getelementptr %struct.mg_http_message, %struct.mg_http_message* %hm, i32 0, i32 5, i32 1\n";
    ...
    ir +=
      "  call void @llvm.memcpy.p0i8.p0i8.i64(i8* %method, i8* %method_buf, i64 %method_len, i1 false)\n";
    ...
    ir +=
      "  call void @llvm.memcpy.p0i8.p0i8.i64(i8* %body, i8* %body_buf, i64 %body_len, i1 false)\n";
    ...
    ir +=
      "  %ct_header_name = getelementptr [13 x i8], [13 x i8]* @.str.content_type_header, i32 0, i32 0\n";
    ir +=
      "  %ct_ptr = call %struct.mg_str* @mg_http_get_header(%struct.mg_http_message* %hm, i8* %ct_header_name)\n";
    ...
    ir +=
      "  call void @llvm.memcpy.p0i8.p0i8.i64(i8* %ct_str, i8* %ct_buf, i64 %ct_len, i1 false)\n";
    ...
    ir += "build_path:\n";
    ir +=
      "  %content_type_val = phi i8* [ %ct_str, %copy_content_type ], [ %empty_ct, %use_empty_ct ]\n";
    ir += "\n";
    ...
    ir += "  ; Copy uri\n";
    ir +=
      "  call void @llvm.memcpy.p0i8.p0i8.i64(i8* %path_full, i8* %uri_buf, i64 %uri_len, i1 false)\n";
    ir += '  ; Add "?"\n';
    ...
    ir +=
      "  call void @llvm.memcpy.p0i8.p0i8.i64(i8* %query_dest, i8* %query_buf, i64 %query_len, i1 false)\n";
    ir += "  ; Null terminate\n";
    ...
    ir +=
      "  call void @llvm.memcpy.p0i8.p0i8.i64(i8* %path_only, i8* %uri_buf, i64 %uri_len, i1 false)\n";
    ...
    ir +=
      "  %req_method_ptr = getelementptr { i8*, i8*, i8*, i8* }, { i8*, i8*, i8*, i8* }* %req_struct, i32 0, i32 0\n";
    ir += "  store i8* %method, i8** %req_method_ptr\n";
    ir += "\n";

    ir += "  ; Store path (field 1)\n";
    ir +=
      "  %req_path_ptr = getelementptr { i8*, i8*, i8*, i8* }, { i8*, i8*, i8*, i8* }* %req_struct, i32 0, i32 1\n";
    ir += "  store i8* %path, i8** %req_path_ptr\n";
    ir += "\n";

    ir += "  ; Store body (field 2)\n";
    ir +=
      "  %req_body_ptr = getelementptr { i8*, i8*, i8*, i8* }, { i8*, i8*, i8*, i8* }* %req_struct, i32 0, i32 2\n";
    ir += "  store i8* %body, i8** %req_body_ptr\n";
    ir += "\n";

    ir += "  ; Store contentType (field 3)\n";
    ir +=
      "  %req_ct_ptr = getelementptr { i8*, i8*, i8*, i8* }, { i8*, i8*, i8*, i8* }* %req_struct, i32 0, i32 3\n";
    ...
    ir += "ct_plain:\n";
    ir +=
      "  %plain_ct = getelementptr [27 x i8], [27 x i8]* @.str.content_type_text, i32 0, i32 0\n";
    ir += "  br label %send_response\n\n";

    ir += "send_response:\n";
    ir +=
      "  %final_ct = phi i8* [ %html_ct, %ct_html ], [ %json_ct, %ct_json ], [ %plain_ct, %ct_plain ]\n";
    ir += "\n";
    ...
    ir +=
      "  %ae_header_name = getelementptr [16 x i8], [16 x i8]* @.str.accept_encoding_header, i32 0, i32 0\n";
    ir +=
      "  %ae_ptr = call %struct.mg_str* @mg_http_get_header(%struct.mg_http_message* %hm, i8* %ae_header_name)\n";
    ...
    ir +=
      "  call void @llvm.memcpy.p0i8.p0i8.i64(i8* %ae_str, i8* %ae_buf, i64 %ae_len, i1 false)\n";
    ...
    ir +=
      "  %zstd_result = call i64 @ZSTD_compress(i8* %zstd_buf, i64 %zstd_max, i8* %response_body, i64 %resp_body_len, i32 1)\n";
    ...
    ir +=
      "  %zstd_resp_fmt = getelementptr [42 x i8], [42 x i8]* @.str.binary_resp_fmt, i32 0, i32 0\n";
    ir +=
      "  call i64 (%struct.mg_connection*, i8*, ...) @mg_printf(%struct.mg_connection* %conn, i8* %zstd_resp_fmt, i32 %status_code, i8* %zstd_combined_hdr, i64 %zstd_result)\n";
    ir += "  call i1 @mg_send(%struct.mg_connection* %conn, i8* %zstd_buf, i64 %zstd_result)\n";
    ir += "  br label %done\n\n";

    ir += "check_ae_deflate:\n";
    ir +=
      "  %deflate_needle = getelementptr [8 x i8], [8 x i8]* @.str.deflate_needle, i32 0, i32 0\n";
    ...
    ir +=
      "  %comp_result = call i32 @compress(i8* %comp_buf, i64* %dest_len_ptr, i8* %response_body, i64 %resp_body_len)\n";
    ...
    ir +=
      "  %deflate_resp_fmt = getelementptr [42 x i8], [42 x i8]* @.str.binary_resp_fmt, i32 0, i32 0\n";
    ir +=
      "  call i64 (%struct.mg_connection*, i8*, ...) @mg_printf(%struct.mg_connection* %conn, i8* %deflate_resp_fmt, i32 %status_code, i8* %combined_hdr, i64 %compressed_len)\n";
    ...
    ir +=
      "  call void (%struct.mg_connection*, i32, i8*, i8*, ...) @mg_http_reply(%struct.mg_connection* %conn, i32 %status_code, i8* %final_ct, i8* %body_fmt, i8* %response_body)\n";
    ir += "\n";
    ...
    ir +=
      '@.str.content_type_text = private constant [27 x i8] c"Content-Type: text/plain\\0D\\0A\\00"\n';
    ir += '@.str.ct_html = private constant [26 x i8] c"Content-Type: text/html\\0D\\0A\\00"\n';
    ir +=
      '@.str.ct_json = private constant [33 x i8] c"Content-Type: application/json\\0D\\0A\\00"\n';
    ...
    ir +=
      '@.str.ce_deflate = private constant [28 x i8] c"Content-Encoding: deflate\\0D\\0A\\00"\n';
    ...
    ir +=
      '@.str.binary_resp_fmt = private constant [42 x i8] c"HTTP/1.1 %d OK\\0D\\0A%sContent-Length: %ld\\0D\\0A\\0D\\0A\\00"\n';
  ...
  private generateWsOpenHandler(wsHandlerName: string): string {
    ...
    ir +=
      "  %ws_open_data_ptr = getelementptr { i8*, i8* }, { i8*, i8* }* %ws_open_evt, i32 0, i32 0\n";
    ir +=
      "  %ws_open_empty = getelementptr [1 x i8], [1 x i8]* @.str.mongoose_empty, i32 0, i32 0\n";
    ir += "  store i8* %ws_open_empty, i8** %ws_open_data_ptr\n";
    ir +=
      "  %ws_open_event_ptr = getelementptr { i8*, i8* }, { i8*, i8* }* %ws_open_evt, i32 0, i32 1\n";
    ir +=
      "  %ws_open_event_str = getelementptr [5 x i8], [5 x i8]* @.str.ws_event_open, i32 0, i32 0\n";
    ...
    ir +=
      "  call i64 @mg_ws_send(%struct.mg_connection* %conn, i8* %ws_open_result, i64 %ws_open_len, i32 1)\n";
    ir += "  br label %done\n\n";
  ...
  private generateWsMsgHandler(wsHandlerName: string): string {
    ...
    ir +=
      "  %ws_data_str_ptr = getelementptr %struct.mg_ws_message, %struct.mg_ws_message* %wm, i32 0, i32 0, i32 0\n";
    ir += "  %ws_data_buf = load i8*, i8** %ws_data_str_ptr\n";
    ir +=
      "  %ws_data_len_ptr = getelementptr %struct.mg_ws_message, %struct.mg_ws_message* %wm, i32 0, i32 0, i32 1\n";
    ...
    ir +=
      "  call void @llvm.memcpy.p0i8.p0i8.i64(i8* %ws_data_copy, i8* %ws_data_buf, i64 %ws_data_len, i1 false)\n";
    ...
    ir +=
      "  %ws_msg_data_ptr = getelementptr { i8*, i8* }, { i8*, i8* }* %ws_msg_evt, i32 0, i32 0\n";
    ir += "  store i8* %ws_data_copy, i8** %ws_msg_data_ptr\n";
    ir +=
      "  %ws_msg_event_ptr = getelementptr { i8*, i8* }, { i8*, i8* }* %ws_msg_evt, i32 0, i32 1\n";
    ir +=
      "  %ws_msg_event_str = getelementptr [8 x i8], [8 x i8]* @.str.ws_event_message, i32 0, i32 0\n";
    ...
    ir +=
      "  call i64 @mg_ws_send(%struct.mg_connection* %conn, i8* %ws_msg_result, i64 %ws_msg_reply_len, i32 1)\n";
    ir += "  br label %done\n\n";
  ...
  private generateWsCloseHandler(wsHandlerName: string): string {
    ...
    ir +=
      "  %ws_close_data_ptr = getelementptr { i8*, i8* }, { i8*, i8* }* %ws_close_evt, i32 0, i32 0\n";
    ir +=
      "  %ws_close_empty = getelementptr [1 x i8], [1 x i8]* @.str.mongoose_empty, i32 0, i32 0\n";
    ir += "  store i8* %ws_close_empty, i8** %ws_close_data_ptr\n";
    ir +=
      "  %ws_close_event_ptr = getelementptr { i8*, i8* }, { i8*, i8* }* %ws_close_evt, i32 0, i32 1\n";
    ir +=
      "  %ws_close_event_str = getelementptr [6 x i8], [6 x i8]* @.str.ws_event_close, i32 0, i32 0\n";
  ...
  generateWsConnectionTracking(): string {
    ...
    ir +=
      "  call void @llvm.memcpy.p0i8.p0i8.i64(i8* %new_arr, i8* %old_i8, i64 %copy_size, i1 false)\n";
    ...
    ir +=
      "  %slot = getelementptr %struct.mg_connection*, %struct.mg_connection** %arr, i64 %idx\n";
    ...
    ir +=
      "  %slot = getelementptr %struct.mg_connection*, %struct.mg_connection** %arr, i64 %i_i64\n";
    ...
    ir +=
      "  %last_slot = getelementptr %struct.mg_connection*, %struct.mg_connection** %arr, i64 %last_i64\n";
  ...
  generateHttpServeFunction(): string {
    ...
    ir +=
      "  %conn = call %struct.mg_connection* @mg_http_listen(%struct.mg_mgr* %mgr, i8* %url, void (%struct.mg_connection*, i32, i8*, i8*)* @__mg_http_handler, i8* %handler_ptr)\n";
    ir += "\n";
    ...
    ir +=
      '@.str.http_listening = private constant [34 x i8] c"HTTP server listening on port %d\\0A\\00"\n';
