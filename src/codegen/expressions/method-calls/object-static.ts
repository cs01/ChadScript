import type { MethodCallNode, VariableNode } from '../../../ast/types.js';
...
function getInterfaceFromAST(ctx: MethodCallGeneratorContext, name: string): InterfaceDefInfo | null {
