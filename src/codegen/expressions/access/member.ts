...
import {
  handleChainedInterfaceAccess,
  accessInterfacePropertyWithNamedStruct,
  accessObjectPropertyWithNamedInterface,
} from "./interface-access.js";
import {
  loadFieldValue,
...
export class MemberAccessGenerator {
  ...
  private handleChainedInterfaceAccess(expr: MemberAccessNode, params: string[]): string | null {
    return handleChainedInterfaceAccess(this.ctx, expr, params);
  }
  ...
  private accessInterfacePropertyWithNamedStruct(
    ...
    return accessInterfacePropertyWithNamedStruct(this.ctx, varName, property, interfaceType);
  }
  ...
  private accessObjectPropertyWithNamedInterface(
    ...
    return accessObjectPropertyWithNamedInterface(this.ctx, objPtr, property, interfaceType);
  }
