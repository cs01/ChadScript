...
import {
  handleClassMethods as _handleClassMethods,
  handleObjectMethods as _handleObjectMethods,
...
export class MethodCallGenerator {
  ...
  private handleClassMethods(expr: MethodCallNode, params: string[]): string | null {
    return _handleClassMethods(this.ctx, expr, params);
  }

  private handleObjectMethods(expr: MethodCallNode, params: string[]): string | null {
    return _handleObjectMethods(this.ctx, expr, params);
  }
