...
import {
  ...
  prePopulateFromSema,
} from "./infrastructure/global-variable-generator.js";
...
export class LLVMGenerator extends BaseGenerator implements IGeneratorContext {
  ...
  public globalVariables: Map<string, { llvmType: string; kind: number; initialized: boolean }>;
  ...
  public semaSymbolNames: string[];
  public semaSymbolTypes: string[];
  private semaSymbolLlvmTypes: string[];
  public semaSymbolSchemaKeys: (string[] | undefined)[];
  public semaSymbolSchemaTypes: (string[] | undefined)[];
  public semaSymbolCount: number;
  ...
  public globalVarSet(
    name: string,
    entry: { llvmType: string; kind: number; initialized: boolean },
  ): void {
    this.globalVariables.set(name, entry);
  }
  public globalVarGet(
    name: string,
  ): { llvmType: string; kind: number; initialized: boolean } | undefined {
    return this.globalVariables.get(name);
  }
  public symbolTableLookup(name: string): Symbol | undefined {
    return this.symbolTable.lookup(name);
  }
  public symbolTableDefineUrl(name: string, allocaReg: string, scope: string): void {
    this.symbolTable.defineUrl(name, allocaReg, scope);
  }
  public symbolTableDefineUrlSearchParams(name: string, allocaReg: string, scope: string): void {
    this.symbolTable.defineUrlSearchParams(name, allocaReg, scope);
  }
  public symbolTableGetObjectArrayElementType(name: string): string | undefined {
    return this.symbolTable.getObjectArrayElementType(name);
  }
  public symbolTableGetRawInterfaceType(name: string): string | undefined {
    return this.symbolTable.getRawInterfaceType(name);
  }
  public symbolTableSetRawInterfaceType(name: string, type: string): void {
    this.symbolTable.setRawInterfaceType(name, type);
  }
  public symbolTableGetResolvedType(name: string): ResolvedType | undefined {
    return this.symbolTable.getResolvedType(name);
  }
  public symbolTableSetResolvedType(name: string, type: ResolvedType): void {
    this.symbolTable.setResolvedType(name, type);
  }
  public symbolTableMarkLLVMConstant(name: string): void {
    this.symbolTable.markLLVMConstant(name);
  }
  public typeInferenceGetJSONParseInterface(mc: MethodCallNode): string | null {
    return this.typeInference.getJSONParseInterface(mc);
  }
  public typeInferenceGetFunctionCallInterfaceReturn(value: Expression): string | null {
    return this.typeInference.getFunctionCallInterfaceReturn(value);
  }
  public typeInferenceGetIndexAccessElementType(value: Expression): string | null {
    return this.typeInference.getIndexAccessElementType(value);
  }
  public typeInferenceIsObjectArrayExpression(value: Expression): boolean {
    return this.typeInference.isObjectArrayExpression(value);
  }
  public typeInferenceIsUint8ArrayExpression(value: Expression): boolean {
    return this.typeInference.isUint8ArrayExpression(value);
  }
  public typeInferenceIsJSONParseExpression(value: Expression): boolean {
    return this.typeInference.isJSONParseExpression(value);
  }
  public typeInferenceGetObjectArrayElementType(value: Expression): string | null {
    return this.typeInference.getObjectArrayElementType(value);
  }
  ...
  generateParts(): string[] {
    ...
    const globalVarDecls = generateGlobalVariableDeclarations(this);
  ...
  public getGenericMethodReturnError(expr: MethodCallNode, varName: string): string | null {
  ...
  public getIndexAccessClassName(expr: Expression): string | null {
  ...
  public getMemberAccessClassName(expr: Expression): string | null {
  ...
  public isKnownClass(name: string): boolean {
  ...
  public tsTypeToLlvmJsonWithEnums(tsType: string): string {
