// Full ArgumentParser Demo - Professional CLI with argparse
// Compile: npx tsx src/index.ts examples/argparse-cli.ts
// Run: ./examples/argparse-cli -v -o output.txt input.txt
