...
- [x] `py-io-bridge.c` — `open()`, file objects, context manager
...
**Test runner:** `node --import tsx --test tests/py-test.ts` — auto-discovers all `.py` in `tests/fixtures-py/`, diffs stdout against `python3`. **24/24 pass.**
