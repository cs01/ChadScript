...
const defaultBenchmarks = {
  ...
  matmul: {
    ...
    metric: 'Smaller = faster.',
    items: [
      { name: 'C', val: '0.430s', w: 68, h: 100, color: 'c', d: 0, speed: 3 },
      { name: 'ChadScript', val: '0.457s', w: 72, h: 94, color: 'chad', d: 0.12, speed: 3.1, hero: true },
      { name: 'Go', val: '0.429s', w: 68, h: 100, color: 'go', d: 0.24, speed: 3 },
      { name: 'Node.js', val: '0.633s', w: 100, h: 68, color: 'node', d: 0.36, speed: 3.7 },
      { name: 'Bun', val: '0.583s', w: 92, h: 74, color: 'bun', d: 0.48, speed: 3.5 },
    ],
  ...
  fibonacci: {
    ...
    items: [
      ...
      { name: 'Node.js', val: '4.37s', w: 100, h: 23, color: 'node', d: 0.36, speed: 8 },
      { name: 'Bun', val: '2.88s', w: 66, h: 35, color: 'bun', d: 0.48, speed: 5.8 },
    ],
  ...
  json: {
    ...
    items: [
      ...
      { name: 'Go', val: '42ms', w: 100, h: 17, color: 'go', d: 0.24, speed: 10.5 },
      { name: 'Node.js', val: '20ms', w: 48, h: 35, color: 'node', d: 0.36, speed: 5.8 },
      { name: 'Bun', val: '9ms', w: 21, h: 78, color: 'bun', d: 0.48, speed: 3.4 },
    ],
  ...
  sqlite: {
    ...
    items: [
      ...
      { name: 'Node.js', val: '0.801s', h: 30, color: 'node', d: 0.24, speed: 6.5 },
      { name: 'Bun', val: '0.637s', h: 38, color: 'bun', d: 0.36, speed: 5.5 },
    ],
