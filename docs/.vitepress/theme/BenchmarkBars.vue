...
const defaultBenchmarks = {
  ...
  matmul: {
    ...
    metric: 'Smaller = faster.',
    items: [
      { name: 'ChadScript', val: '0.45s', w: 74, h: 100, color: 'chad', d: 0, hero: true, speed: 1.5 },
      { name: 'C', val: '0.45s', w: 74, h: 100, color: 'c', d: 0.12, speed: 1.5 },
      { name: 'Go', val: '0.46s', w: 75, h: 98, color: 'go', d: 0.24, speed: 1.6 },
      { name: 'Node.js', val: '0.61s', w: 100, h: 74, color: 'node', d: 0.36, speed: 2.0 },
      { name: 'Bun', val: '0.61s', w: 100, h: 74, color: 'bun', d: 0.48, speed: 2.0 },
    ],
  ...
  fibonacci: {
    ...
    metric: 'Smaller = faster.',
    items: [
      { name: 'C', val: '1.04s', w: 23, h: 100, color: 'c', d: 0, speed: 1.5 },
      { name: 'ChadScript', val: '1.7s', w: 37, h: 61, color: 'chad', d: 0.12, hero: true, speed: 1.8 },
  ...
  json: {
    ...
    items: [
      ...
      { name: 'ChadScript', val: '8ms', w: 24, h: 75, color: 'chad', d: 0.12, hero: true, speed: 1.6 },
  ...
  sqlite: {
    ...
    items: [
      ...
      { name: 'ChadScript', val: '290K qps', h: 71, color: 'chad', d: 0.12, hero: true, speed: 2.2 },
