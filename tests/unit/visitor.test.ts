...
class CountingVisitor extends RecursiveASTVisitor {
  ...
  visitMethodCallNode(node: MethodCallNode): void {
    this.inc("method_call");
    super.visitMethodCallNode(node);
  }
  visitVariableDeclaration(node: VariableDeclaration): void {
    this.inc("variable_declaration");
