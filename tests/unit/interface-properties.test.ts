...
describe('getInterfaceProperties', () => {
  ...
  it('should return matching keys and types for single-field interface', () => {
    const gen = createGenerator([
      { name: 'Point', fields: [{ name: 'x', type: 'number' }] },
    ]);
  ...
  it('should strip optional marker from interface name', () => {
    const gen = createGenerator([
      { name: 'Item', fields: [{ name: 'id', type: 'number' }] },
    ]);
  ...
  it('should select correct interface among multiple', () => {
    const gen = createGenerator([
      ...
      { name: 'B', fields: [{ name: 'b1', type: 'number' }, { name: 'b2', type: 'boolean' }] },
      { name: 'C', fields: [{ name: 'c1', type: 'string' }, { name: 'c2', type: 'string' }, { name: 'c3', type: 'number' }] },
    ]);
